...
namespace Ordenacao
{
    internal class Util
    {
        ...
        /// </summary>
        /// <param name="lista">estrutura de armanezamento dos números</param>
        ...
        /// </summary>
        /// <param name="lista">contendo números inteiros</param>
...
List<string> listaPalavaras = new List<string>();

Util.popularAleatorioNumeros(listaNumeros, 10, 100, 500);
Util.exibirListaNumeros(listaNumeros);

lista2Numeros.AddRange(listaNumeros); // AddRange: Fazer uma cópia da listaNumeros
